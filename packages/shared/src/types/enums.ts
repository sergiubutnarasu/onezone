export enum EventCommands {
  ...
  ProjectBuilderCommand = "terminal:project-builder-command",
  ProjectBuilderCommandStop = "terminal:project-builder-command:stop",
  ProjectBuilderCommandFinished = "terminal:project-builder-command:finished",
